...
export class LoginApi {
     ...
     */
    public apiLogin(userLoginData: models.LoginData, extraHttpRequestParams?: any): Observable<models.SuccessResponse> {
        return this.apiLoginWithHttpInfo(userLoginData, extraHttpRequestParams)
    ...
    public apiLoginWithHttpInfo(userLoginData: models.LoginData, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/apiLogin`;
        ...
        let requestOptions: RequestOptionsArgs = new RequestOptions({
            ...
            headers: headers,
            body: userLoginData == null ? '' : JSON.stringify(userLoginData), // https://github.com/angular/angular/issues/10612
